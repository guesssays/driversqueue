...
export function ScreensPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-700 text-white p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <h1 className="text-4xl md:text-5xl font-bold">Электронная очередь</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur rounded-lg p-6 border-2 border-white/20">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Регистрация</h2>
            {screenState?.reg?.current ? (
              <div className="text-center">
                <div className="text-5xl md:text-7xl font-bold mb-4 text-yellow-300 animate-pulse">
              ...
              <div className="text-center text-3xl md:text-4xl text-gray-300 py-12">Ожидание...</div>
            )}
          </div>

          {/* Technical Queue */}
          <div className="bg-white/10 backdrop-blur rounded-lg p-6 border-2 border-white/20">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Технические вопросы</h2>
        ...
        <div className="bg-white/10 backdrop-blur rounded-lg p-6">
          <h2 className="text-xl md:text-2xl font-bold mb-4">Последние вызовы</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {screenState?.lastCalls?.slice(0, 8).map((ticket: QueueTicket) => (
              ...
              >
                <div className="text-xl md:text-2xl font-bold">{ticket.ticket_number}</div>
